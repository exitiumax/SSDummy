  ...
  const navigationItems = [
    ...
    },
    {
      ...
      dropdownItems: [
        ...
        { name: 'Practice Tests', path: '/resources/practice-tests' },
      ]
    }
  ];
              ...
              {navigationItems.map((item) => (
                ...
                >
                  {item.name === 'Services' ? (
                    ...
                    <span
                      className={`text-lg font-medium text-[#0085c2] hover:text-[#FFB546] transition-colors duration-200 cursor-pointer ${
